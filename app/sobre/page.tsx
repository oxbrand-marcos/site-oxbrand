    ...
    <main>
        ...
        <div className="relative z-10 flex-1 flex items-center justify-center py-28 px-6">
          <div className="max-w-5xl flex flex-col items-center text-center gap-8">
            ...
            <nav aria-label="Breadcrumb" className="flex items-center gap-2">
              ...
              <span className="mono-tag text-primary/70">Sobre</span>
            </nav>

            <h1 className="text-[clamp(2.8rem,7vw,5.5rem)] font-bold leading-[0.92] tracking-tight text-foreground text-balance">
              Dois sócios, um método e{' '}
              <span className="text-glow">responsabilidade sobre o resultado.</span>
            </h1>

            <p className="text-base sm:text-lg text-muted-foreground leading-relaxed max-w-4xl text-balance">
              A OxBrand é uma agência de marketing digital de Mogi das Cruzes, conduzida por dois sócios com perfis
              complementares, com operação desde 2014 e 25 anos de experiência combinada entre os sócios. À frente de um time multidisciplinar, unimos
              estratégia, criação e performance para transformar marketing em estrutura de crescimento: método,
              dados e responsabilidade sobre o resultado do cliente.
            </p>
      ...
      <section className="py-24 border-b border-border bg-background">
        <div className="max-w-3xl mx-auto px-6 flex flex-col gap-10">
          <span className="mono-tag text-primary/70">Manifesto</span>
          <div className="flex flex-col gap-8 text-lg sm:text-xl leading-relaxed text-foreground font-medium">
            <p>
              Marketing virou barulho. Promessas vazias, métricas de vaidade e estratégias copiadas de gurus.
              Empresas investem, geram leads, mas o faturamento não escala. O problema nunca foi a falta de
              marketing. É falta de estrutura.
            </p>
            <p>
              Não acreditamos em postzinho bonitinho. Não acreditamos em volume sem direção.
              Não aceitamos código sem rastreio ou design que não converte.
            </p>
            <p>
              Na OxBrand, marketing só faz sentido quando gera avanço real de negócio. Crescimento não é tentativa.
              É sistema.
            </p>
            <p className="text-muted-foreground">
              Enquanto vendem execução, nós entregamos direção. Enquanto prometem alcance, nós construímos
              previsibilidade.
            </p>
            <p className="text-2xl sm:text-3xl font-bold text-foreground border-l-2 border-primary pl-6">
              Não operamos com achismo.<br />Operamos com dados.
            </p>
          </div>
        </div>
      </section>

      {/* Sobre — histórico e pilares */}
      <About />
