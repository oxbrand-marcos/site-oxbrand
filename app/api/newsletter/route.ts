...
<body style="margin:0;padding:0;background:#f9fafb;font-family:sans-serif">
  <div style="max-width:600px;margin:40px auto;background:#fff;border:1px solid #e5e7eb">
    <div style="background:#0a0a0a;padding:24px 32px">
      ...
      <span style="color:#3f3f3f;font-size:13px;margin-left:12px;font-family:monospace">Nova inscrição · Newsletter</span>
    </div>
    <div style="padding:32px">
      <table style="width:100%;border-collapse:collapse">
        <tr><td style="padding:8px 12px;font-weight:600;color:#6b21a8;font-family:monospace;font-size:12px;text-transform:uppercase;border-bottom:1px solid #f3f4f6">Nome</td><td style="padding:8px 12px;color:#111827;font-size:14px;border-bottom:1px solid #f3f4f6">${name}</td></tr>
