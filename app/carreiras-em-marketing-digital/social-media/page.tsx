        ...
        <section className="relative min-h-[56vh] flex flex-col justify-end overflow-hidden bg-background">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 pb-16 pt-32 w-full flex flex-col items-center text-center gap-8">
            <nav aria-label="Breadcrumb" className="flex items-center gap-2">
              ...
              <span className="mono-tag text-muted-foreground/20">/</span>
              <span className="mono-tag text-primary/70">SOCIAL MEDIA</span>
            </nav>
          ...
          <div className="relative z-10 w-full bg-primary/90 px-6 py-3 flex flex-col sm:flex-row items-center justify-center sm:justify-between gap-1 sm:gap-0">
            <span className="mono-tag text-white">Vagas para Social Media</span>
            <span className="mono-tag text-white/60 hidden sm:block">OxBrand / Vagas - Social Media</span>
          </div>
        </section>
        ...
        <section className="py-20 border-b border-border bg-background">
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex flex-col lg:grid lg:grid-cols-2 gap-16">
              ...
              <div className="flex flex-col gap-6 border border-border p-8 bg-card/30 h-fit items-center text-center lg:items-start lg:text-left">
                ...
                <a
                  href="https://wa.me/+5511921425351?text=Ol%C3%A1%2C+tenho+interesse+na+vaga+de+Social+Media+da+OxBrand!"
                  target="_blank"
                ...
                <div className="flex flex-col gap-3 border-t border-border pt-4">
                  ...
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="text-foreground font-medium text-right">Mogi das Cruzes / SP<br /><span className="text-xs text-muted-foreground font-normal">Edifício Office – CEP 08780-500</span></span>
                  </div>
                  <div className="flex items-center justify-between text-sm">
                    <span className="mono-tag text-muted-foreground/50">Área</span>
                    <span className="text-foreground font-medium">Conteúdo & Social</span>
                  </div>
                </div>
              </div>
            </div>
