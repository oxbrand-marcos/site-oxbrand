...
const categoriesData = [
  {
    ...
    items: [
      ...
      { slug: 'idv-agua-rasa', alt: 'Água Rasa' },
      ...
      { slug: 'idv-truck-center', alt: 'Truck Center' },
  ...
  },
  {
    ...
    label: 'Social Media',
    items: [
      { slug: 'social-agua-rasa', alt: 'Água Rasa' },
      ...
      { slug: 'social-cia-do-caminhao', alt: 'Cia do Caminhão' },
      ...
      { slug: 'social-dna-colchoes', alt: 'DNA Colchões' },
      ...
      { slug: 'social-motobras-premium', alt: 'Motobras Premium' },
  ...
  },
  {
    ...
    items: [
      ...
      { slug: 'site-bmr', alt: 'BMR', videoId: null },
      ...
      { slug: 'site-lbel', alt: 'LBEL', videoId: null },
      ...
      { slug: 'site-motobras-premium', alt: 'Motobras Premium', videoId: null },
      ...
      { slug: 'site-truck-center', alt: 'Truck Center', videoId: null },
  ...
  },
  {
    ...
    label: 'CRM',
    items: [
      { slug: 'crm-chris-tattoo', alt: 'Chris Tattoo' },
      { slug: 'crm-consulting', alt: 'Consulting' },
      { slug: 'crm-lbel', alt: 'LBEL' },
      { slug: 'crm-mara-rocha', alt: 'Mara Rocha' },
      { slug: 'crm-truck-center', alt: 'Truck Center' },
    ],
  },
  {
    id: 'trafego',
