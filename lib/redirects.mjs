...
export function buildRedirects() {
  ...
  return [
    ...
    // Legadas 404 reportadas no Google Search Console (recuperar autoridade)
    ...rule('/assessoria-de-marketing-premium',    '/solucoes/assessoria-em-marketing'),
    ...rule('/gestao-de-trafego-performance',      '/solucoes/gestao-de-trafego-pago'),
    ...rule('/crm-integracao-marketing-midiapaga-first-party', '/blog/o-que-e-crm'),
    ...
    // Cases e portfólio legados do WordPress → equivalentes no site novo
    ...rule('/cases-e-resultados-grupo-motobras-marketing',        '/nossos-clientes/motobras'),
    ...rule('/cases-e-resultados-truck-center-express-marketing',  '/nossos-clientes/truck-center-express'),
    ...rule('/cases-resultados-digitais-marketing-oxbrand',        '/nossos-clientes'),
    ...rule('/portfolio-resultados-marketing-estrategia-oxbrand',  '/portfolio'),
    ...rule('/seo-local-dicas-google-ads-otimizacao-marketing',    '/agencia-de-marketing-digital-mogi-das-cruzes'),
    ...
    // ─── Backlinks quebrados (SEMrush) → 301 p/ recuperar autoridade ─────
    ...rule('/como-criar-uma-estrategia-de-marketing-digital-eficaz', '/blog/consultoria-de-marketing-digital'),
    ...rule('/estrategias-avancadas-de-cro-o-que-mais-voce-pode-fazer-para-otimizar-as-conversoes', '/blog/funil-de-vendas'),
    ...rule('/como-o-remarketing-pode-aumentar-suas-vendas-e-fidelizar-clientes', '/solucoes/gestao-de-trafego-pago'),
    ...rule('/otimizacao-de-conversao-cro-estrategias-oxbrand', '/blog/funil-de-vendas'),
  ]
}
