...
export const CASES: CaseStudy[] = [
  ...
  draft('Mara Rocha', 'mara-rocha', ''),
  {
    ...
    metaDescription: 'Rebranding completo da BMR – Blaustein, Mendes & Ramalho Advogados: identidade visual, posicionamento e site à altura de +20 anos de autoridade jurídica. Case OxBrand.',
